...
### Objectives:
- Analyze the anonymized [data](https://www.kaggle.com/c/CartWise_Instacart-Market-Basket-Optimization-/data) of 3 million grocery orders from more than 200,000 Instacart users open sourced by Instacart 
